...
// If there are fields below, create the methods in dao\Template_Impl.go
   ...
   r.ExtraField_Extra  = template_ExtraField_Extra_ExtraStore (r)
   r.ExtraField2_Extra  = template_ExtraField2_Extra_ExtraStore (r)
  ...
  r.FIELD2  = template_FIELD2_OverrideStore (r)
...
// If there are fields below, create the methods in dao\Template_Impl.go
  ...
  recItem.FIELD2  = template_FIELD2_OverrideFetch (recItem)
