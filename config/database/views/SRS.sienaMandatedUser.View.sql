...
GO
/****** Object:  View [{{!SQL.SCHEMA}}].[sienaMandatedUser]    Script Date: 04/12/2021 18:16:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT        {{!SQL.SOURCE}}.MandatedUser.MandatedUserKeyCounterpartyFirm, {{!SQL.SOURCE}}.MandatedUser.MandatedUserKeyCounterpartyCentre, {{!SQL.SOURCE}}.MandatedUser.MandatedUserKeyUserName, {{!SQL.SOURCE}}.MandatedUser.TelephoneNumber, 
                         ...
                         {{!SQL.SOURCE}}.Centre.FullName AS CentreName, {{!SQL.SOURCE}}.MandatedUser.Notify, {{!SQL.SOURCE}}.MandatedUser.SystemUser, { fn CONCAT({{!SQL.SOURCE}}.MandatedUser.MandatedUserKeyCounterpartyFirm, { fn CONCAT('|', 
                         {{!SQL.SOURCE}}.MandatedUser.MandatedUserKeyCounterpartyCentre) }) } AS CompID
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 10440
         Alias = ' , @level0type=N'SCHEMA',@level0name=N'SRS', @level1type=N'VIEW',@level1name=N'sienaMandatedUser'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'900
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'SRS', @level1type=N'VIEW',@level1name=N'sienaMandatedUser'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'SRS', @level1type=N'VIEW',@level1name=N'sienaMandatedUser'
GO
