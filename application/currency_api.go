...
// ----------------------------------------------------------------
// Automatically generated  "/application/currency_api.go"
// ----------------------------------------------------------------
// Package              : application
...
//Currency_Handler is the handler for the api calls
func Currency_Handler(w http.ResponseWriter, r *http.Request) {
	...
	switch httpMethod {
	case http.MethodGet:
		currency_MethodGet(w, r)

	case http.MethodPost:
		currency_MethodPost(w, r)

	case http.MethodPut:
		currency_MethodPost(w, r)
	case http.MethodDelete:

		currency_MethodDelete(w, r)
	default:
		http.Error(w, http.StatusText(http.StatusMethodNotAllowed), http.StatusMethodNotAllowed)
	}
}

// Handles GET requests for Currency
func currency_MethodGet(w http.ResponseWriter, r *http.Request) {
	...
	if searchID == "" {
		...
		noRecs, records, _ := dao.Currency_GetList()
		var ci core.ContentList
		ci.Count = noRecs
		ci.Key = dm.Currency_QueryString
		...
		_, record, _ := dao.Currency_GetByID(searchID)
		//spew.Dump(record)
...
//Handles POST & PUT requests for Currency
func currency_MethodPost(w http.ResponseWriter, r *http.Request) {
